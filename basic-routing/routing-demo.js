...
app.get('/info', function(req, res) {
    console.log("Got a GET request for /info");
    res.send('Hello User! Even if things are hard, do not lose your dream.');
})

var server = app.listen(3212, 'localhost', function() {
